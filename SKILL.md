...
- `ugc_prompts.json` must be model-generated from the valid manifest + image analysis + product brief. Do not hand-author canonical production prompts unless the user explicitly asks for a manual experiment.
